...
<head>
	<meta charset = "UTF-8">
	<title>Voto Online - Cadastro CPF</title>
...
<body>
	<div id="cadastrar"><a href="index.php" title="CADASTRE SEU CPF SOMENTE A LOJA 0697!"> FAÇA LOGIN &raquo;</a></div>
		...
		<div class="message">
			<div class="logo"><a href="<?php echo $home;?>"title="<?php echo $title;?>"><img src="_imagens/logo-extra4.png" alt="<?php echo $title;?>" wight="250" height="72"/><a></div><!--LOGO-->
				...
				<div class="acomodar">
					...
					<label for="cpf">CPF: (Somente números)</label><input id="cpf" type="cpf" class="txt bradius" name="cpf">
					<label for="nome">SETOR: (Mercearia, Flv, ...) </label><input id="setor" type="text" class="txt bradius" name="setor">
